        ...
        public static IHtmlString ShapeIcon(int id)
        {
            ...
            switch (id)
            {
                ...
                case 4: // Hình tam giác
                    inner =
                        "<polygon points='11,2 20,20 2,20' fill='#e0e0e0' stroke='#666' stroke-width='1.5' stroke-linejoin='round'/>";
                    break;
                case 5: // Hình vuông
                    inner =
                        "<rect x='2' y='2' width='18' height='18' fill='#e0e0e0' stroke='#666' stroke-width='1.5'/>";
                    break;
                case 6: // Hình lục giác
                    inner =
                        "<polygon points='11,1 20,6 20,16 11,21 2,16 2,6' fill='#e0e0e0' stroke='#666' stroke-width='1.5' stroke-linejoin='round'/>";
                    break;
                case 7: // Hình khác
                    inner =
                        "<circle cx='11' cy='11' r='9' fill='#e0e0e0' stroke='#666' stroke-width='1.5' stroke-dasharray='3,2'/>";
                    break;
                ...
                case 12: // Hình chữ nhật
                    inner =
                        "<rect x='1' y='5' width='20' height='12' fill='#e0e0e0' stroke='#666' stroke-width='1.5'/>";
                    break;
                case 13: // Hình thoi
                    inner =
                        "<polygon points='11,1 21,11 11,21 1,11' fill='#e0e0e0' stroke='#666' stroke-width='1.5' stroke-linejoin='round'/>";
                    break;
                case 14: // Hình ngũ giác (pentagon)
                    inner =
                        "<polygon points='11,2 20,8 16,19 6,19 2,8' fill='#e0e0e0' stroke='#666' stroke-width='1.5' stroke-linejoin='round'/>";
                    break;
                case 15: // Hình thất giác (heptagon)
                    inner =
                        "<polygon points='11,2 18,5 20,13 15,19 7,19 2,13 4,5' fill='#e0e0e0' stroke='#666' stroke-width='1.5' stroke-linejoin='round'/>";
                    break;
